      ...
      <div class="asideBot">
        ...
        <div id="eight" class="tabcontent">
          <div class="tablinkTop tablinkMain">
            <a class="tablinkImg" href="RWD_coursein.php?sid=<?= $t[0][0] ?>">
          ...
          <div class="tablinkBot tablinkMain">
            ...
            <a class="tablinkImg" href="RWD_coursein.php?sid=<?= $t[1][0] ?>">
        ...
        <div id="nine" class="tabcontent">
          <div class="tablinkTop tablinkMain">
            <a class="tablinkImg" href="RWD_coursein.php?sid=<?= $t[2][0] ?>">
          ...
          <div class="tablinkBot tablinkMain">
            ...
            <a class="tablinkImg" href="RWD_coursein.php?sid=<?= $t[3][0] ?>">
        ...
        <div id="ten" class="tabcontent">
          <div class="tablinkTop tablinkMain">
            <a class="tablinkImg" href="RWD_coursein.php?sid=<?= $t[4][0] ?>">
          ...
          <div class="tablinkBot tablinkMain">
            ...
            <a class="tablinkImg" href="RWD_coursein.php?sid=<?= $t[5][0] ?>">
