    ...
    <section class="velo-slides" data-velo-slider="on" data-velo-theme="light">
      <section class="velo-slide">
        ...
        <header class="velo-slide__header">
          ...
          <span class="velo-slide__btn"><a class="btn-draw btn--white" href="<?= WEB_ROOT ?>/RWD_Wedding.php?sid=1"><span class="btn-draw__text"><span>觀看更多</span></span></a></span>
        </header>
      </section>
      <!-- ------------------我是分隔線------------------------------------- -->
      <section class="velo-slide">
        ...
        <header class="velo-slide__header">
          ...
          <span class="velo-slide__btn"><a class="btn-draw btn--white" href="<?= WEB_ROOT ?>/RWD_Wedding.php?sid=2"><span class="btn-draw__text"><span>觀看更多</span></span></a></span>
        </header>
      </section>
      <!-- ------------------我是分隔線------------------------------------- -->
      <section class="velo-slide">
        ...
        <header class="velo-slide__header">
          ...
          <span class="velo-slide__btn"><a class="btn-draw btn--white" href="<?= WEB_ROOT ?>/RWD_Wedding.php?sid=3"><span class="btn-draw__text"><span>觀看更多</span></span></a></span>
        </header>
      </section>
      <!-- ------------------我是分隔線------------------------------------- -->
      <section class="velo-slide">
        ...
        <header class="velo-slide__header">
          ...
          <span class="velo-slide__btn"><a class="btn-draw btn--white" href="<?= WEB_ROOT ?>/RWD_Wedding.php?sid=5"><span class="btn-draw__text"><span>觀看更多</span></span></a></span>
        </header>
      </section>
      <!-- ------------------我是分隔線------------------------------------- -->
      <section class="velo-slide">
        ...
        <header class="velo-slide__header">
          ...
          <span class="velo-slide__btn"><a class="btn-draw btn--white" href="<?= WEB_ROOT ?>/RWD_Wedding.php?sid=7"><span class="btn-draw__text"><span>觀看更多</span></span></a></span>
        </header>
      </section>
      <!-- ------------------我是分隔線------------------------------------- -->
      <section class="velo-slide">
        ...
        <header class="velo-slide__header">
          ...
          <span class="velo-slide__btn"><a class="btn-draw btn--white" href="<?= WEB_ROOT ?>/RWD_Wedding.php?sid=9"><span class="btn-draw__text"><span>觀看更多</span></span></a></span>
        </header>
      </section>
      <!-- ------------------我是分隔線------------------------------------- -->
