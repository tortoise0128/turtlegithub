...
<div class="Goback">
<button class="fas fa-angle-left" onclick="location.href='<?= WEB_ROOT ?>/Wedding-1.php'">
<p>Back</p>
</button>
</div>
<div class="container">
    <div class="main01">
        <article class="article-main">
            <div class="article-text col-lg-7" data-aos="fade-right" data-aos-offset="500" data-aos-easing="ease-in-sine"> <!-- aos1 -->
        ...
        <figure class="article-pic col-lg-6" data-aos="fade-left" data-aos-anchor="#example-anchor" data-aos-offset="500" data-aos-duration="500"> <!-- aos2 -->
    ...
    <article class="article-main-2">
        ...
        <div class="d-flex"  data-aos="fade-up" data-aos-duration="500"> <!-- aos3 -->
    ...
    <div class="article-main-two">
        <div class="article-pic-two">
            <figure class="pic4" data-aos="fade-up" data-aos-duration="1000"> <!-- aos4 -->
                <img class="imgFix" src="img/Wedding/OK/<?= $row["layout_img"]?>-4.jpg" alt="">
            </figure>
            <figure class="pic5" data-aos="fade-up" data-aos-duration="1500"> <!-- aos5 -->
                <img class="imgFix" src="img/Wedding/OK/<?= $row["layout_img"]?>-5.jpg" alt="">
            </figure>
            <figure class="pic6" data-aos="fade-up" data-aos-duration="2000"> <!-- aos6 -->
                <img class="imgFix" src="img/Wedding/OK/<?= $row["layout_img"]?>-6.jpg" alt="">
            </figure>
        </div>
        <div class="article-text-two">
            <span><h1 data-aos="fade-left">你可以獲得</h1></span> <!-- aos7 -->
            <div data-aos="fade-left" data-aos-duration="1000"> <!-- aos8 -->
                <h3 >Serum</h3>
                <p><?= $row["intro2"]?></p>
                <hr>
            </div>
            <div data-aos="fade-left" data-aos-duration="1000"> <!-- aos9 -->
            ...
            <div data-aos="fade-left" data-aos-duration="2000"> <!-- aos10 -->
    ...
    <div class="article-main-three d-flex">
        <div class=" pic7 " data-aos="fade-left" data-aos-duration="2000"> <!-- aos11 -->
            <img class="imgFix" src="img/Wedding/people<?= $row["designer_img"]?>.jpg" alt="">
        </div>
        <div class="designer col-lg-7" data-aos="fade-left" data-aos-duration="2500"> <!-- aos12 -->
            <h2><?= $row["designer"]?></h2>
