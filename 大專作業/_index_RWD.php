...
<header>
    ...
    <div class="container">
        <div class="sec1">
            ...
            <div class="summer-img1 "><img class="imgFix" src="img/Bouquet/summer test/Summer East (3).jpg" alt=""></div>
        </div>
    </div>
    <div class="container">
        <div class="sec2">
            <div class="summer-img2">
                <img class="img-summer imgFix" src="img/Bouquet/summer test/Summer East (4).jpg" alt="">
                <div class="info-1">
                    <p class="flowerTitle">Simply Cafe Latte</p>
                    <p class="flowerPrice">NT 2,450</p>
                </div>
            </div>
            <div class="summer-img3">
                <img class="img-summer imgFix" src="img/Bouquet/summer test/Summer East (2).jpg" alt="">
                <div class="info-1">
                    <p class="flowerTitle">Simply Cafe Latte</p>
                    <p class="flowerPrice">NT 2,450</p>
                </div>
    ...
    <div class="container-over">
        <div class="summer-overimg courseImgAll"><img src="img/course/red.jpg" alt=""></div>
    </div>
    ...
    <!-- 第二個課程 -->
    <div class="container-over">
        <div class="summer-overimg courseImgAll"><img src="img/course/white.jpg" alt=""></div>
    </div>
