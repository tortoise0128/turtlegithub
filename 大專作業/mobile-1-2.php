...
<div>
  ...
  <ul class="ListC">
  <ul class="ListC">
      <li class="listD active01" class="active "><a onclick="location.href='<?= WEB_ROOT ?>/mobile-1-2.php'">會員中心</a></li>
    ...
    <form class="col-sm-6" style="padding:30px;" name="form1" method="post">
        ...
        <div class="password">
            ...
            <a  class="passwordMain" href="<?= WEB_ROOT ?>/mobile-1-3newpassword.php">設定新密碼</a>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <select id="inputState county" class="form-control" data-val="<?= $r['county'] ?>" for="county" name="county"> 
                <option value="">城市/縣</option>
                <option value="">...</option>
                <option value="">...</option>
                <option value="">...</option>
            </select>
            <select class="form-control" id="city" name="city" data-val="<?= $r['city'] ?>" for="city">
                <option value="">區/市/鄉/鎮</option>
                <option value="">信義區</option>
                <option value="">大安區</option>
                <option value="">中山區</option>
            </select>
            <br>
            <input type="address" class="form-control" id="exampleFormControlInput1 address"  name="address" value="<?= $r['address'] ?>" for="address">
        </div>
