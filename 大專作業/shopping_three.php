...
<body>
            ...
            <?php if ($_SESSION['receiver']) : ?>
                <div class="member">
                    <div class="member_title">
                        <h2 class="content_title_text">訂單確認</h2>
                    </div>
                    ...
                    <div class="datail_button">
                        <div>
                            <a type="button" class="LastPage" href="<?= WEB_ROOT ?>/shopping_CheckOrder.php">修改</a>
                        </div>
                        <div>
                            <a type="button" class="NextPage buyBtn" onclick="changePage()">確認結帳</a>
                        </div>
                    </div>
    ...
    <script>
        ...
        function changePage(){
            ...
            setTimeout(function(){
                location.href = 'shopping_finish.php';
            },2000)        
        };
    </script>
