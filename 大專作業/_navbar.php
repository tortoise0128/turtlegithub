...
<div class="collapse navbar-collapse d-flex" id="navbarSupportedContent">
    <div class="col-lg-10">
        <ul class="navbar-nav d-flex justify-content-around navLeft ">
            ...
            <li class="nav-item">
                <a class="nav-link " href="<?= WEB_ROOT ?>/course.php" >Course</a>
            </li>
            
            <li class="nav-item active">
                <a class="nav-link" href="<?= WEB_ROOT ?>/_about_us.php">About Us</a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= WEB_ROOT ?>/Wedding-1.php">Layout</a>
            </li>
        </ul>
    </div>
            ...
            <?php if(isset($_SESSION['member'])): ?>
                <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="<?= WEB_ROOT ?>/member.php">會員中心</a>
                            <a class="dropdown-item" href="<?= WEB_ROOT ?>/member-Tracking.php">訂單查詢</a>
                  ...
                  <div>
                    <div>
                      <ul>
                        ...
                        <li><a href="<?= WEB_ROOT ?>/course.php">Course</a></li>
                        <li><a href="<?= WEB_ROOT ?>/_about_us.php">About</a></li>
                        <li><a href="<?= WEB_ROOT ?>/Wedding-1.php">Layout</a></li>
                        <li><a href="<?= WEB_ROOT ?>/member.php">Member</a></li>
