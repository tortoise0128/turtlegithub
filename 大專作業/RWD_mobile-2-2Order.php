...
<div class="container">
  <div>
    <div class="main">
      <div class="icon" ><a class="fas fa-redo-alt" href="RWD_mobile-2Order.php"></a></div>
      <div class="timeline">
    ...
    <tr class="allProduct">
      ...
      <td>
        <div class="productItem">
          <div class="textItem">
            <p class="nameWork"><?= $c['product_name'] ?></p><br>
          </div>
        </div>
      </td>
      <!-- <td>
        <div class="productItem2 "><= $c['size'] ?></div>
      </td> -->
      <td>
        <div class="productItem2 "><?= $c['quantity'] ?></div>
      </td>
      <td>
        <div class="productItem2 ">NT.<?= $c['price']*$c['quantity'] ?></div>
      </td>
